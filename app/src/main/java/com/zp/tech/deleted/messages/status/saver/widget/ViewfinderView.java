...
public class ViewfinderView extends View {
    ...
    private int mFrameCornersSize = 30;
    private int mFrameCornersRadius = 30;
    ...
    private void init(){
        ...
        mMaskPaint.setColor(ContextCompat.getColor(getContext(), R.color.maskColor));
        ...
        paint.setColor(ContextCompat.getColor(getContext(), R.color.frameColor));
    ...
    protected void onDraw(@NonNull final Canvas canvas) {
        ...
        if (showLine) {
            canvas.drawLine(left+left/2, mPosY, (mFrameRect.getWidth()+left)-left/2, mPosY, paint);
