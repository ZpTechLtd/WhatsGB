...
import com.zp.tech.deleted.messages.status.saver.adapters.QrCreationAdapter
import com.zp.tech.deleted.messages.status.saver.databinding.FragmentHistoryGeneratedBinding
...
class HistoryGeneratedFragment : Fragment() {

    private var binding: FragmentHistoryGeneratedBinding? = null
    private var viewModel: ScannerSharedViewModel? = null
    private var adapter: QrCreationAdapter? = null
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_history_generated, container, false)
        ...
        adapter = QrCreationAdapter(viewModel!!, this, listOf())
