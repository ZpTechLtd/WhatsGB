...
import com.zp.tech.deleted.messages.status.saver.ui.scanner.HistoryScannedFragment
...
class QRHistoryAdapter(
    val viewModel: ScannerSharedViewModel,
    val context: HistoryScannedFragment,
    private var list: List<Scanner>
) :
    RecyclerView.Adapter<QRHistoryAdapter.Holder>() {
